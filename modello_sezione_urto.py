...
##############################################################################################################
#I have generated 5.000.000 Upsilon(1S/2S/3S) events and selected the p-n, p-p and n-n pairs that can be
...
df_pp = root_pandas.read_root('pp_U1S_recap.root', key='pp_U1S_recap_tree')
df_pp.head(5)
...
df_nn = root_pandas.read_root('nn_U1S_recap.root', key='nn_U1S_recap_tree')
df_nn.head(5)
...
sigma_0_invers = 1.29 * 1e-6  #ub^-1, invers value of the Cross Section fenomenological parameter
...
#np.savetxt('p_sez_urto_U1S_babar.dat', p_deuter)
